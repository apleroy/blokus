...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { game_id: @move.game_id, piece_id: @move.piece_id, squares: @move.squares, user_id: @move.user_id }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { game_id: @move.game_id, piece_id: @move.piece_id, squares: @move.squares, user_id: @move.user_id }
    assert_redirected_to move_path(assigns(:move))
  end
